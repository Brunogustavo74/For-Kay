const PHRASES = [
  ...
  "Você é minha canção sem fim 🎶 💖",
  "Meu destino é você 💫 💖",
  "Nosso amor é para sempre 🔥 💖",
  "Ao seu lado, sou feliz 💖",
  "Amo você mais a cada dia 💖",
  "Seu amor me inspira 🎨 💖",
  "Você é meu lar e minha aventura 🗺️ 💖",
  ...
  "Minha vida 💓",
  "Minha princesa 👑",
  "Beldade e beleza em pessoa 💃",
  "Minha Vênus 🌹",
  "Minha Monalisa 🎨",
  "Meu girassol de Van Gogh 🌻",
  "Minha noite estrelada 🌌",
  "Minha partitura predileta 🎶",
  "Meu quadro favorito 🖼️",
  "Meu tudo 💖"
];
